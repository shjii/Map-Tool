...
bool main::PreRender()
{
	...
	m_pd3dContext->ClearDepthStencilView(m_pDSV,D3D11_CLEAR_DEPTH
...
bool main::Init()
{
	...
	hr = DirectX::CreateWICTextureFromFile(m_pd3dDevice, L"../../data/bitmap/png/main_start_pus.png", NULL, &m_pTextureSRV);
