...
public:
	...
	ID3D11ShaderResourceView*	StagingCopyTextureFromSV(ID3D11Device* pDevice, ID3D11DeviceContext* pImmediateContext, int index, vector<PNCT_VERTEX> list, SMap* map);
	...
	void			WriteDotPixel(ID3D11DeviceContext*   pImmediateContext, ID3D11Texture2D* pTexDest, int index, vector<PNCT_VERTEX> list, SMap* map);
