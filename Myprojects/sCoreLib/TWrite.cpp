...
#include "TTimer.h"
////////////////////////////////////////////////////////
HRESULT TDxWrite::CreateIndependentResource()
{
...
void TDxWrite::DeleteDependentResource()
{
	if (m_pBrush)
	{
		m_pBrush->Release();
...
void TDxWrite::Draw(POINT pos, wstring msg, DWORD color)
{
	std::lock_guard<std::mutex> lock(m_hMutex);
